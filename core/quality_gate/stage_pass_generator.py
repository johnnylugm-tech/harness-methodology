...
_warnings.warn(
    "stage_pass_generator.py is deprecated since harness-methodology v2.5.0. "
    "STAGE_PASS.md is now machine-generated by finalize-gate. "
    "The 'stage-pass' CLI command does not exist.",
    DeprecationWarning,
    stacklevel=2,
)

...
- **Canonical rule text** (`harness/prompts/rules/R-CANONICAL-INTERP-001.md` — this doc is a declared surface; kept byte-equal by `tests/test_the_constitution_carries_the_live_rule.py`):

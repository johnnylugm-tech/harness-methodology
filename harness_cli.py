...
def _harness_workflow_template(phase: int) -> str:
    """Return the content of .github/workflows/harness_gate.yml for a target project."""
    return f"""\
...
def cmd_init_project(args: argparse.Namespace) -> int:
    ...
    Automates INTEGRATION.md §3 steps:
      ...
      2. Write .github/workflows/harness_gate.yml
    ...
    workflow_path = workflows_dir / "harness_gate.yml"

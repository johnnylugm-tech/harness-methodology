# Phase 4 Full Execution Plan -- golden-fixture-project
...
### FR Test Coverage (2 FRs)

#### FR-01: [See SRS.md for test targets]
...
- **PUSH ⑤ — P4-mid** (trigger when ≥1/2 FRs have Gate 1 PASS):
  ```bash
...
- **PUSH ⑥ — P4-pre-gate3** (trigger when all 2 FRs Gate 1 PASS, before Gate 3):
  ```bash

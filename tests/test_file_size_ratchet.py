...
_LINE_CEILING: dict[str, int] = {
    ...
    "core/quality_gate/mutation_enforcer.py": 1390,  # 2026-08-24: +14 — commit d552fc35: R71-站1 custody-wrap `_compute_mutation_score`'s live mutmut run with `core.tree_custody.custody()`, identical to R53-站1's `run_mutation_precheck` pattern to restore source when subprocess is SIGKILLed. Previous: 1376.

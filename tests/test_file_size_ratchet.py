...
_LINE_CEILING: dict[str, int] = {
    ...
    "cli/fr_cmds.py": 2365,  # 2026-08-23: +82 — commit f0de7ea: `_detect_evaluator_passed_but_commit_uncommitted` helper + `[HARNESS-BUG]` recovery banner in `_abort_no_progress_with_self_doubt` for FR-99 non-convergence recovery, using `core.state_io.load_quality_manifest`. Previous: 2283.

...
_LINE_CEILING: dict[str, int] = {
    ...
    "cli/fr_cmds.py": 2382,  # 2026-08-23: +4 — Round 70 站1: the FR-99 recovery diagnostic's `score_gate` stops being a literal and reads `effective_score_gate(1)`, the same function finalize_gate resolves its own bar with. The literal had been wrong twice (100.0, then 80.0 while the verdict used 1.0). Previous: 2378.

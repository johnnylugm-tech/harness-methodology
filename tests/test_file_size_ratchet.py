...
_LINE_CEILING: dict[str, int] = {
    ...
    # what needs amending.
    "cli/project_cmds.py": 2082,  # 2026-07-28: +50 lines — fix/cli-init-project-step-10b: init-project step 10b auto-installs pyyaml+jsonschema from harness/requirements.txt into project .venv to eliminate first-call ModuleNotFoundError crashes. 2026-07-27: +13 — Round 29: _check_content_quality gained two per-file-type exemptions (MAINTENANCE_LOG.md from section-count floor, TEST_RESULTS.md from FR-ref rule).

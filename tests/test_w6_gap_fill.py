...
Targets: hybrid_workflow, sessions_spawn_logger, phase_hooks,
         agent_proof_hook, stage_pass_generator.
(enforcement_config / verification_gate sections removed in Round 9 站0
along with the zombie modules they covered.)
"""
import json
import pytest

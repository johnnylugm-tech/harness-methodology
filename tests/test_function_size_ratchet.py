...
_CEILINGS: dict[str, int] = {
    ...
    "cli/fr_cmds.py::cmd_run_fr_step": 856,  # 2026-09-07: 810 -> 856 — Round 102 站2: canonical budget-kill / blocked-human failure rows in the escalation recorders and both blocked exits, plus the fix-round pre-dispatch repeated_failure refusal. Previous: 810.

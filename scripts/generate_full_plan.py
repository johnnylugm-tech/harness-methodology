...
def _review_checkpoint(phase: int, checkpoint_n: int) -> List[str]:
    ...
    lines += [
        ...
        f"  > Phase {phase} deliverable IDs = phase deliverables (see `harness_cli.py _PHASE_DELIVERABLES[{phase}]`, e.g., for Phase 1: SRS, SPEC_TRACKING, TRACEABILITY_MATRIX, TEST_INVENTORY).",

...
|---|---|---|---|
| `ANTHROPIC_API_KEY` | SSI runner, agent_spawner | — | Optional — only needed when `STEERING_PROVIDER_TYPE=anthropic` (Steering LLM judge). Not required for gate evaluation (Gates 1–4 use tool-based scoring only). |

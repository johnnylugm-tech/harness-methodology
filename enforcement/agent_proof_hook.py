...
# Set commit message file path from git argument
if len(sys.argv) > 1:
    os.environ["COMMIT_MSG_FILE"] = sys.argv[1]
...
'''
    ...
    def __init__(self, project_root: Optional[str] = None):
        ...
        self.hook_path = self.project_root / ".git" / "hooks" / "commit-msg"
